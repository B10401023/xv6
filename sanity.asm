...
main(int argc, char *argv[])
{
 ...
 183:	dd 05 f0 0b 00 00    	fldl   0xbf0
 189:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 190:	dc c1                	fadd   %st,%st(1)
 192:	d9 05 f8 0b 00 00    	flds   0xbf8
 ...
 238:	51                   	push   %ecx
 239:	52                   	push   %edx
 23a:	68 00 0b 00 00       	push   $0xb00
 23f:	6a 01                	push   $0x1
 241:	e8 2a 04 00 00       	call   670 <printf>
	printf(1, "I/O bound:\nAverage ready time: %d\nAverage running time: %d\nAverage sleeping time: %d\nAverage turnaround time: %d\n\n\n", sums[2][0], sums[2][1], sums[2][2], sums[2][0] + sums[2][1] + sums[2][2]);
 ...
 259:	51                   	push   %ecx
 25a:	52                   	push   %edx
 25b:	68 78 0b 00 00       	push   $0xb78
 260:	6a 01                	push   $0x1
 262:	e8 09 04 00 00       	call   670 <printf>
	exit();
 ...
 281:	52                   	push   %edx
 282:	51                   	push   %ecx
 283:	68 3c 0a 00 00       	push   $0xa3c
 288:	6a 01                	push   $0x1
 28a:	e8 e1 03 00 00       	call   670 <printf>
				sums[2][0] += retime;
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 60f:	f7 f6                	div    %esi
 611:	0f b6 92 04 0c 00 00 	movzbl 0xc04(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 788:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 78b:	b8 fc 0b 00 00       	mov    $0xbfc,%eax
...
free(void *ap)
{
 ...
 811:	a1 a8 0e 00 00       	mov    0xea8,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 867:	89 08                	mov    %ecx,(%eax)
  freep = p;
 869:	a3 a8 0e 00 00       	mov    %eax,0xea8
}
 86e:	5b                   	pop    %ebx
 86f:	5e                   	pop    %esi
 870:	5f                   	pop    %edi
 ...
 88a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 88d:	a3 a8 0e 00 00       	mov    %eax,0xea8
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 8a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 8ac:	8b 15 a8 0e 00 00    	mov    0xea8,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 8ff:	76 3f                	jbe    940 <malloc+0xa0>
    ...
    if(p == freep)
 901:	39 05 a8 0e 00 00    	cmp    %eax,0xea8
 ...
 926:	e8 e5 fe ff ff       	call   810 <free>
  return freep;
 92b:	8b 15 a8 0e 00 00    	mov    0xea8,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 94c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 94f:	89 15 a8 0e 00 00    	mov    %edx,0xea8
      return (void*)(p + 1);
 ...
 964:	eb e9                	jmp    94f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 966:	c7 05 a8 0e 00 00 ac 	movl   $0xeac,0xea8
 96d:	0e 00 00 
 970:	c7 05 ac 0e 00 00 ac 	movl   $0xeac,0xeac
 977:	0e 00 00 
    base.s.size = 0;
 97a:	b8 ac 0e 00 00       	mov    $0xeac,%eax
 97f:	c7 05 b0 0e 00 00 00 	movl   $0x0,0xeb0
 986:	00 00 00 
