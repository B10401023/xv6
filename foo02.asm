...
int main(int argc, char **argv) {
  ...
  // first child   
  if (fork() == 0) {
   f:	e8 f6 02 00 00       	call   30a <fork>
  14:	85 c0                	test   %eax,%eax
  16:	75 24                	jne    3c <main+0x3c>
  18:	bb 64 00 00 00       	mov    $0x64,%ebx
...
int to_be_or_not(int to_be) {
  ...
  // second child
  if(fork() == 0) {
  3c:	e8 c9 02 00 00       	call   30a <fork>
  41:	85 c0                	test   %eax,%eax
  43:	75 24                	jne    69 <main+0x69>
  45:	bb 64 00 00 00       	mov    $0x64,%ebx
...
int to_be_or_not(int to_be) {
  ...
  // parent
  wait();
  69:	e8 ac 02 00 00       	call   31a <wait>
  wait();
  6e:	e8 a7 02 00 00       	call   31a <wait>
  73:	eb c2                	jmp    37 <main+0x37>
  75:	66 90                	xchg   %ax,%ax
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
...
int to_be_or_not(int to_be) {
  ...
  88:	bb 64 00 00 00       	mov    $0x64,%ebx
  8d:	eb 18                	jmp    a7 <to_be_or_not+0x27>
  8f:	90                   	nop
  int count = 0;
...
int to_be_or_not(int to_be) {
  ...
  a5:	74 1b                	je     c2 <to_be_or_not+0x42>
    if (to_be) printf(1, "to be!\n");
  a7:	85 f6                	test   %esi,%esi
  a9:	74 e5                	je     90 <to_be_or_not+0x10>
  ab:	83 ec 08             	sub    $0x8,%esp
  ae:	68 b4 07 00 00       	push   $0x7b4
  b3:	6a 01                	push   $0x1
  b5:	e8 d6 03 00 00       	call   490 <printf>
...
int to_be_or_not(int to_be) {
  ...
  while(count++ < TH) {
  bd:	83 eb 01             	sub    $0x1,%ebx
  c0:	75 e5                	jne    a7 <to_be_or_not+0x27>
    if (to_be) printf(1, "to be!\n");
    if (!to_be) printf(1, "not to be!\n");
    //sleep(1);
  }
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 42f:	f7 f6                	div    %esi
 431:	0f b6 92 c4 07 00 00 	movzbl 0x7c4(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5a8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5ab:	b8 bc 07 00 00       	mov    $0x7bc,%eax
...
free(void *ap)
{
 ...
 687:	89 08                	mov    %ecx,(%eax)
  freep = p;
 689:	a3 88 0a 00 00       	mov    %eax,0xa88
}
 68e:	5b                   	pop    %ebx
 68f:	5e                   	pop    %esi
 690:	5f                   	pop    %edi
 ...
 6aa:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6ad:	a3 88 0a 00 00       	mov    %eax,0xa88
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 76c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 76f:	89 15 88 0a 00 00    	mov    %edx,0xa88
      return (void*)(p + 1);
 ...
 784:	eb e9                	jmp    76f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 786:	c7 05 88 0a 00 00 8c 	movl   $0xa8c,0xa88
 78d:	0a 00 00 
 790:	c7 05 8c 0a 00 00 8c 	movl   $0xa8c,0xa8c
 797:	0a 00 00 
    base.s.size = 0;
 79a:	b8 8c 0a 00 00       	mov    $0xa8c,%eax
 79f:	c7 05 90 0a 00 00 00 	movl   $0x0,0xa90
 7a6:	00 00 00 
